            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 style="color:#337ab7;">Add New Comment</h3>
                    ...
                    <form role="form" method="post" enctype="multipart/form-data" action="{{url('/add/new/comment')}}" >
                    {{csrf_field()}}
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Comment</label>
                                    <textarea name="com_comment" class="form-control" rows="5" placeholder="Enter Constraint" required></textarea>
                                </div>
                            </div>
